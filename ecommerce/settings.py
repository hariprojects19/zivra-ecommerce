...
SECRET_KEY = 'django-insecure-3*uhtm(7dt5nwoctwjv6c$5$euha&%i*#bhmb)ig)dy-qq%0rt'
...
INSTALLED_APPS = [
    ...
    'store',#django-app
    'cart',#2nd django app
    'account',#3rd django app
    'payment',#4th django app
    'mathfilters',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.views.categories',# this is to display the categories in all pages across the website
